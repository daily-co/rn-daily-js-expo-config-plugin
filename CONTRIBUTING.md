...
Thank you for looking into contributing to `rn-daily-js-expo-config-plugin`! 
...
2. If you're still seeing the error, check to see if somebody else has [already filed the issue](https://github.com/daily-co/rn-daily-js-expo-config-plugin/issues) before creating a new one.
